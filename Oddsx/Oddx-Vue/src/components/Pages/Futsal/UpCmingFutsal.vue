          ...
          <div class="top_matches__main">
            <div class="row w-100 mb-8 mb-md-10">
              <div class="col-12">
                ...
                >
                  <img :src="russia" width="{32}" height="{32}" alt="Icon" />
                  <h3>Russia</h3>
                </div>
...
import russia from "@/assets/images/icon/russia.png";
import futsal from "@/assets/images/icon/futsal.png";
import futsalLeague from "@/assets/images/icon/futsal-league.png";
import chart from "@/assets/images/icon/line-chart.png";
import star from "@/assets/images/icon/star2.png";
import colomiers from "@/assets/images/icon/colomiers-rugby.png";
import nevers from "@/assets/images/icon/uson-nevers.png";
import stade from "@/assets/images/icon/stade-aur.png";

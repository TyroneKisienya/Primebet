<template>
  <section class="top_matches mb-10">
                  ...
                  >
                    <div class="row gx-0 gy-xl-0 gy-7">
                      <div class="col-xl-5 col-xxl-4">
                        <div class="top_matches__clubname">
                          <div
                            class="top_matches__cmncard-right d-flex align-items-start justify-content-between pb-4 mb-4 
                            gap-4"
                          >
                            <div class="d-flex align-items-center gap-1">
                              <img
...
import { amricanFootballUpCE } from "../assets/data/tabThree";
